...
public class MyEditor extends JFrame implements ActionListener {
	...
	public MyEditor() {
		...
		btnNew.setIcon(new ImageIcon("C:\\Coding\\Java_Intellij\\src\\main\\java\\classes\\GUI\\img\\new.png"));
		toolBar.add(btnNew);
		
		JButton btnOpen = new JButton("");
		btnOpen.setIcon(new ImageIcon("C:\\Coding\\Java_Intellij\\src\\main\\java\\classes\\GUI\\img\\open.png"));
		toolBar.add(btnOpen);
		
		JButton btnSave = new JButton("");
		btnSave.setIcon(new ImageIcon("C:\\Coding\\Java_Intellij\\src\\main\\java\\classes\\GUI\\img\\save.png"));
		toolBar.add(btnSave);
		...
		btnExit.setIcon(new ImageIcon("C:\\Coding\\Java_Intellij\\src\\main\\java\\classes\\GUI\\img\\exit.png"));
		toolBar.add(btnExit);
	}
